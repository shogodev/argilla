...
class m010102_000007_product_content extends CDbMigration
{
    ...
    $this->execute("INSERT INTO `{{product_tree_assignment}}` (`src`, `src_id`, `dst`, `dst_id`) VALUES
      ('type', 1, 'section', 2),
      ('type', 2, 'section', 2),
      ('type', 3, 'section', 2);");
    ...
    $this->execute("INSERT INTO  `{{faceted_parameter}}` (`id` , `parameter`) VALUES (2 , 'type_id');");
    $this->execute("INSERT INTO  `{{faceted_parameter}}` (`id` , `parameter`) VALUES (3 , '3');");
    $this->execute("INSERT INTO  `{{faceted_parameter}}` (`id` , `parameter`) VALUES (4 , '4');");
    ...
    $this->delete('{{product_param_name}}', 'id IN (3, 4)');
    $this->delete('{{product_param_name}}', 'id IN (2)');
    $this->delete('{{product_type}}', 'id IN (2, 3, 4)');

    $this->delete('{{product}}', 'id IN (1, 2, 3, 4, 5)');
    $this->delete('{{product_assignment}}', 'id IN ( 2, 3, 4, 5, 6)');
    $this->delete('{{product_section}}', 'id IN (1, 2)');
    $this->delete('{{product_type}}', 'id IN (1, 2, 3)');
    $this->delete('{{product_tree_assignment}}', 'src_id IN (1, 2, 3)');
    $this->delete('{{association}}', '1');
    $this->delete('{{faceted_parameter}}', 'id IN (1, 2, 3, 4)');
