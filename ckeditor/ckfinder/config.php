...
function CheckAuthentication()
{
  ...
  //chmod('/usr/www/kazanchik/html/f/upload/_thumbs/', 0777);

  @session_start();
  $dir   = str_replace("ckeditor/ckfinder", "", __DIR__);
  $appId = sprintf('%x', crc32($dir.'backend/protected'.'backend'));
  $key   = md5('Yii.CWebUser.'.$appId).'__id';
